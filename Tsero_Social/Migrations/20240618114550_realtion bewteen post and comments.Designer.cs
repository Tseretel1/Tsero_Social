...
namespace Tsero_Social.Migrations
{
    ...
    [Migration("20240618114550_realtion bewteen post and comments")]
    partial class realtionbewteenpostandcomments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tsero_Social.Models.Comments", b =>
                {
                    b.HasOne("Tsero_Social.Models.Post", null)
                        .WithMany("Comments")
                        .HasForeignKey("PostID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tsero_Social.Models.User", null)
                        .WithMany("Commetns")
