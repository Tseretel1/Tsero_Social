                    ...
                    if (logedUser!=null)
                    {
                        ...
                        ViewBag.CurrentUser = _userDbcontext.Users.Where(u=> u.id == UserID).ToList();
                            if (logedUser != null)
                            {
                                ...
                                var NotificationCount = _userDbcontext.Notifications.Where(u => u.ReceiverID == logedUser.id).Count();
                                ViewBag.Notification = NotificationCount;

                                var Notification = _userDbcontext.Notifications.Where(u => u.ReceiverID == logedUser.id).ToList();
